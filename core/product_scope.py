...
_CATEGORY_TERMS = {
    ...
    "power tools": r"\b(?:drill|grinder|circular saw|mitre saw|miter saw|sander|impact driver|rotary hammer|electric planer|planer)\b",
    "garden/outdoor tools": r"\b(?:chainsaw|chain saw|hedge trimmer|lawn mower|brushcutter|leaf blower)\b",
