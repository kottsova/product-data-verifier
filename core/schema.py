...
CATEGORY_ATTRIBUTES: dict[str, tuple[AttributeDefinition, ...]] = {
    ...
    "laptop": (
        _definition("display_size", ("display size", "screen size", "screen diagonal"), value_type="dimension", unit_family="display_size", priority="critical"),
        _definition("display_type", ("display type", "screen type", "panel type"), value_type="enum", priority="medium"),
        ...
        _definition("ram", ("ram", "memory", "system memory", "installed memory"), value_type="capacity", unit_family="digital_storage", attribute_scope="variant_level", priority="critical"),
        _definition("storage", ("storage", "ssd", "solid state drive", "hard drive"), value_type="capacity", unit_family="digital_storage", attribute_scope="variant_level", priority="critical"),
